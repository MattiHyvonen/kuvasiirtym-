...
kuvanPiirtaja::kuvanPiirtaja() {
    ...
    shaderit[SEKOITUS_A].lataa(vs, "data/shaderit/sekoitus_a.fsh");
    shaderit[SYRJAYTYS_R].lataa(vs, "data/shaderit/syrjaytys_r.fsh");
    shaderit[OFFSET].lataa(vs, "data/shaderit/offset.fsh");
    shaderit[SEKOITUS_VALO].lataa(vs, "data/shaderit/sekoitus_valo.fsh");
